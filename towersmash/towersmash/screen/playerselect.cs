...
namespace towersmash
{
    class playerselect: MenuScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            //draw back and start
            spriteBatch.DrawString(ScreenManager.Font, "Press Start to start the game! \n Press Back to go back to the main menu.", new Vector2(towersmash.screen_width * .1f, towersmash.screen_height - (towersmash.screen_height * .2f)), Color.White);
            spriteBatch.End();
        }
    }
}