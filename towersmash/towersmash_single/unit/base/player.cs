...
{ 
    ...
    public class player: gunit
    {
        ...
        public void handleinput(InputState input)
        {
            ...
            if (input.CurrentGamePadStates[(int)playerindex].Triggers.Right > .5f)
            {
            ...
            //If the player holds the left trigger, then they will activate their sheild
        ...
        {
            aimdirection.Y = -aimdirection.Y;
            aimdirection += this.position;
            pweapon.shoot(aimdirection);
        }
